    ...
    <div className="flex flex-col lg:flex-row ">
     ...
     <div className="flex flex-col ml-8">
      <div className="flex items-center">
       ...
       <div className="w-4/5">
        <h3 className="text-secondary text-lg font-semibold mb-1">Address:</h3>
      ...
      <div className="flex items-center my-10">
       ...
       <div className="w-4/5">
        <h3 className="text-secondary text-lg font-semibold mb-1">Phone:</h3>
        <p className="text-neutral9 text-sm font-normal">+79934403545</p>
       </div>
      </div>
      <div className="flex items-center">
       <div className="bg-primary mr-3 rounded-[50%] w-[50px] h-[50px] flex items-center justify-center">
       ...
       <div className="w-4/5">
        <h3 className="text-secondary text-lg font-semibold mb-1">Email:</h3>
        <p className="text-neutral9 text-sm font-normal">studyiger@gmail.com</p>
       </div>
      </div>
     </div>
    </div>
