   ...
   <Layout>
    ...
    <div className="max-w-screen-sm p-5 lg:p-0 lg:max-w-screen-lg md:max-w-screen-md mx-auto mt-20">
     <div className="flex justify-between flex-col  md:flex-col lg:flex-row items-center lg:items-start">
      ...
      <div className="w-full md:w-full lg:w-1/2">
       <p className="text-neutral9 text-lg font-normal">
        Study in Russia is your most popular resource dedicated to help foreign
        students looking for education in Russian universities with all
        information they need in order to make informed decisions about Russia.
        You can study in English or in Russian language its your choice to
        choose! Our friendly and knowledgeable staff will ensure you receive
        good quality timely advice support in preparation for your education in
        Russia and your student life during your stay in Russia.{' '}
       </p>
      </div>
     </div>
    </div>
    <div className="my-20 p-5 lg:p-0 max-w-screen-sm lg:max-w-screen-lg md:max-w-screen-md mx-auto">
     ...
     <p className="text-neutral9 text-lg font-normal text-center my-5">
      ...
      planning to study in Russia. Whatever your goal and however much support
      you need, we have a service to suit you.
     </p>
     <div className="flex justify-between flex-col items-center gap-6  md:flex-col md:items-center lg:grid lg:grid-cols-3 ">
      <div className="flex flex-col w-full hover:shadow-2xl p-6 lg:h-full rounded-lg items-center md:w-2/3 lg:w-full">
       ...
       <p className="text-neutral9 text-sm font-normal">
        ...
        Russian university, available to all students. Our advisors will assist
        with the application process, edit your personal statement and inform
        you of which documents are required and what deadlines must be met.
       </p>
      </div>
      <div className="flex flex-col items-center hover:shadow-2xl p-6 rounded-lg lg:h-full w-full lg:w-full  md:w-2/3">
       ...
       <p className="text-neutral9 text-sm font-normal">
        We will reserve your accomodation in the university campus, to make your
        transfer smooth and everything prepared specially for you.
       </p>
      </div>
      <div className="flex flex-col  w-full lg:w-full  hover:shadow-2xl lg:h-full p-6 rounded-lg items-center md:w-2/3">
       ...
       <p className="text-neutral9 text-sm font-normal">
        Get your documents translated into Russian and notarized by a certified
        Russian notary. Timeframe: 1 to 3 days. To be admitted to studies, you
        will need to have your passport, education credentials and medical
